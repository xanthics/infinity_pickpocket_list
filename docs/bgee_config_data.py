...
types = {
	"Amulet": [
		...
		"The One Gift Lost",
		"The Protector +1",
		"bdamul09.ITM (not in TLK)",
		"bdamul24.ITM (not in TLK)",
		"bdamul25.ITM (not in TLK)",
	],
	"Armor": [
		"Ankheg Plate Mail",
		"Chain Mail",
	...
	"Belt & Girdle": [
		...
		"bdbelt01.ITM (not in TLK)",
		"bdbelt03.ITM (not in TLK)",
		"bdbelt12.ITM (not in TLK)",
		"bdbelt13.ITM (not in TLK)",
		"bdbelt14.ITM (not in TLK)",
	],
	"Bolts": [
		"Bolt",
		"Bolt +1",
	...
	"Books & misc": [
		...
		"bdbwoosh.ITM (not in TLK)",
		"bdjar.ITM (not in TLK)",
		"bdmisc04.ITM (not in TLK)",
		"bdmisc08.ITM (not in TLK)",
		"bdmisc25.ITM (not in TLK)",
		"bdmisc51.ITM (not in TLK)",
		"bdmisc52.ITM (not in TLK)",
		"bdmisc58.ITM (not in TLK)",
		"bdpetsg.ITM (not in TLK)",
		"rndaro01.ITM",
		"rndgem01.ITM",
		"rndgem02.ITM",
		"rndgem03.ITM",
	...
	"Bracers & gauntlets": [
		...
		"bdbrac01.ITM (not in TLK)",
		"bdbrac03.ITM (not in TLK)",
		"bdbrac09.ITM (not in TLK)",
		"bdbrac10.ITM (not in TLK)",
		"bdbrac13.ITM (not in TLK)",
		"bdbrac14.ITM (not in TLK)",
	],
	"Bullets": [
		"Bullet",
		"Bullet +1",
	...
	"Drinks (IWD)": [
		"BDMISC29.ITM (not in TLK)",
		"De'Tranion's Baalor Ale",
		"bdjuice.ITM (not in TLK)",
	],
	"Flail": [
		"Flail",
		"Flail +1",
	...
	"Hat": [
		...
		"bdhelm12.ITM (not in TLK)",
	],
	"Headgear": [
		"Helmet",
		"bdhelm05.ITM (not in TLK)",
		"bdmisc05.ITM (not in TLK)",
	],
	"Key": [
		"bdkey05.ITM (not in TLK)",
		"bdkey07.ITM (not in TLK)",
		"bdkey11.ITM (not in TLK)",
		"bdkey12.ITM (not in TLK)",
		"bdshkey.ITM (not in TLK)",
	],
	"Large sword": [
		"Bastard Sword",
		"Gold Digger +1",
		...
		"Scimitar +1",
		"Two-handed Sword",
		"bdsw1h03.ITM (not in TLK)",
		"bdsw1h08.ITM (not in TLK)",
	],
	"Mace & Club": [
		"Club",
		"Club +1",
		"Mace",
		"Mace +1",
		"bdblun01.ITM (not in TLK)",
		"bdblun02.ITM (not in TLK)",
	],
	"Morning star": [
		"Morning Star",
	],
	"Potion": [
		...
		"Violet Potion",
		"bdmisc02.ITM (not in TLK)",
		"bdpotn06.ITM (not in TLK)",
		"potn60.ITM (not in TLK)",
	],
	"Quarterstaff": [
		"Quarterstaff",
		"Quarterstaff +1",
	...
	"Ring": [
		...
		"The Victor",
		"Topsider's Crutch",
		"bdring04.ITM (not in TLK)",
		"bdring06.ITM (not in TLK)",
		"bdring08.ITM (not in TLK)",
		"bdring09.ITM (not in TLK)",
		"bdring10.ITM (not in TLK)",
		"bdring12.ITM (not in TLK)",
	],
	"Scroll": [
		...
		"Web",
		"Wraithform",
		"bdbflye2.ITM (not in TLK)",
		"bdbflyer.ITM (not in TLK)",
		"bdscrl1.ITM (not in TLK)",
	],
	"Shield": [
		"Buckler",
		"Buckler +1",
		...
		"Medium Shield +1",
		"Small Shield",
		"bdmisc10.ITM (not in TLK)",
		"bdshld02.ITM (not in TLK)",
	],
	"Sling": [
		"Sling",
		"Sling +1",
	...
	"Unknown": [
		"bdbody01.ITM (not in TLK)",
		"bdbody02.ITM (not in TLK)",
		"bdbody03.ITM (not in TLK)",
	],
	"Wand": [
		"Wand of Fear",
		"Wand of Fire",
