...
types = {
	...
	"Books & misc": [
		...
		"Piece of Red Cloth",
		"Qilue's Brain",
		"RNDARO01.itm (not in TLK)",
		"RNDGEM01.itm (not in TLK)",
		"RNDGEM02.itm (not in TLK)",
		"RNDGEM03.itm (not in TLK)",
		"RNDMAG01.itm (not in TLK)",
		"RNDMAG06.itm (not in TLK)",
		"RNDPTN01.itm (not in TLK)",
		"RNDSCR01.itm (not in TLK)",
		"RNDSCR04.itm (not in TLK)",
		"RNDTRE01.ITM (not in TLK)",
		"RNDTRE02.ITM (not in TLK)",
		"RNDTRE03.ITM (not in TLK)",
		"RNDTRE04.ITM (not in TLK)",
		"RNDTRE05.ITM (not in TLK)",
		"RNDTRE06.itm (not in TLK)",
		"RNDTRE07.itm (not in TLK)",
		"RNDTRE08.itm (not in TLK)",
		"RNDTRE09.itm (not in TLK)",
		"RNDTRI02.itm (not in TLK)",
		"RNDWAND.itm (not in TLK)",
		"Rebel's Orb",
		"Rope",
		"SODTRE09.itm (not in TLK)",
		"Sea Charts",
		"Seal of Caelar",
